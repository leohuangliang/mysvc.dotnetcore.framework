...
namespace MySvc.Framework.Infrastructure.Crosscutting.EventBus
{
    ...
    public interface IIntegrationEventService
    {
        ...
        /// </summary>
        /// <param name="evt">集成事件对象</param>
        Task SaveIntegrationEvent<T>(object evt) where T : class;
        ...
        /// </summary>
        /// <param name="evts">集成事件对象列表</param>
        Task SaveIntegrationEvent<T>(IList<object> evts) where T : class;
        /// <summary>
        /// 发布所有消息
        /// </summary>
        ...
        Task PublishIntegrationEventWithoutSave<T>(object @event) where T : class;
    }
}
